    ...
    public Move(int oldX, int oldY, int newX, int newY, Piece piece){
        ...
        if(piece.getColor() == false){ //case that piece is white
            if(piece.getType() == "Queen"){
                ...
                p = new Rook(piece.getContext(), piece.getX()/piece.getSize(),piece.getY()/piece.getSize(),piece.getSize(),false);
            }else if(piece.getType() == "Knight"){
                p = new Knight(piece.getContext(), piece.getX()/piece.getSize(),piece.getY()/piece.getSize(),piece.getSize(),false);
            }else if(piece.getType() == "Pawn"){
                p = new Pawn(piece.getContext(), piece.getX()/piece.getSize(),piece.getY()/piece.getSize(),piece.getSize(),false);
            }else if(piece.getType() == "Bishop"){
                p = new Bishop(piece.getContext(), piece.getX()/piece.getSize(), piece.getY()/piece.getSize(), piece.getSize(),false);
            }else if(piece.getType() == "King"){
                p = new King(piece.getContext(), piece.getX()/piece.getSize(),piece.getY()/piece.getSize(),piece.getSize(),false);
            }
        }else if(piece.getColor() == true){ //case that piece is black
            if(piece.getType() == "Queen"){
                p = new Queen(piece.getContext(), piece.getX()/piece.getSize(),piece.getY()/piece.getSize(),piece.getSize(),true);
            }else if(piece.getType()== "Bishop"){
                p = new Bishop(piece.getContext(), piece.getX()/piece.getSize(),piece.getY()/piece.getSize(),piece.getSize(),true);
            }else if(piece.getType() == "Rook"){
                p = new Rook(piece.getContext(), piece.getX()/piece.getSize(),piece.getY()/piece.getSize(),piece.getSize(),true);
            }else if(piece.getType() == "Knight"){
                p = new Knight(piece.getContext(), piece.getX()/piece.getSize(),piece.getY()/piece.getSize(),piece.getSize(),true);
            }else if(piece.getType() == "Pawn"){
                p = new Pawn(piece.getContext(), piece.getX()/piece.getSize(),piece.getY()/piece.getSize(),piece.getSize(),true);
            }else if(piece.getType() == "King"){
                p = new King(piece.getContext(), piece.getX()/piece.getSize(),piece.getY()/piece.getSize(),piece.getSize(),true);
            }
        }
    }
